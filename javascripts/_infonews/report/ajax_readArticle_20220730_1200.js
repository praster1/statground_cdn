...
{
	url = "/report/get_read_article_readArticle_report/?requestUUID=" + requestUUID
	...
	$.ajax({
		...
		success:function(data){
			...
			html += '<button type="button" class="mb-xs mt-xs mr-xs btn btn-primary" onclick="window.open(\'' + data.ContentURL.toString() + '\')"><i class="fa-solid fa-newspaper mr-sm"></i> 상세 링크</button>'
