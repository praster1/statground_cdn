...
{
	url = "/book/get_read_article_readArticle_book/?requestUUID=" + requestUUID
	...
	$.ajax({
		...
		success:function(data){
			...
			// 버튼
			html = ""
			html += '<button type="button" class="mb-xs mt-xs mr-xs btn btn-primary" onclick="window.open(\'' + data.link.toString() + '\')"><i class="fa-solid fa-book mr-sm"></i> 상세 링크</button>'
