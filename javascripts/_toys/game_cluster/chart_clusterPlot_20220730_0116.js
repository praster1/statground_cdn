	...
	$.ajax({
		...
		success:function(data){
			...
			function drawChart() {				
				...
				var chart = new google.visualization.ScatterChart(document.getElementById('chart_cluster'));
			...
			html = '<span class="input-group-addon btn-dark" id="btn_sign">　클러스터 개수:　</span>'
			...
			html += 'placeholder="" '
			html += 'min="1" max="7" autocomplete="off" '
			html += 'autofocus>'
