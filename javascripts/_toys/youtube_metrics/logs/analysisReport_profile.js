function analysisReport_profile(inputData)
{
	...
	html += '<span class="input-group-addon btn-danger"><i class="fa fa-youtube-play" style="color:white;" aria-hidden="true"></i> 채널 바로가기</span>'
	html += '</a>'
	html += '<a href="' + dataURL +'" class="btn btn-primary" role="button" target="_blank">'
	html += '<span class="input-group-addon btn-success"><i class="fa fa-tasks" style="color:white;" aria-hidden="true"></i> 데이터 다운로드</span>'
	html += '</a>'
